...
- `remark-dgmo` `^0.11.0` (moved 2026-07-31 — a caret on `0.x` locks the minor, so this never happens on its own)
- peers: `@diagrammo/dgmo` `>=0.57.0 <1`, `nextra` `^4.0.0`, `next` `^15 || ^16`, `react` `^19`
